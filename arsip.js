...
if (numDisplayed == postTitle.length) {
   var tocNote = '<span class="toc-note">Arsip ' + postTitle.length + ' Tulisan Panjaaang<br/></span>'; }
else {
   var tocNote = '<span class="toc-note">Tulisan ' + numDisplayed + ' berlabel \'';
